...
class AbstractReportXslx(models.AbstractModel):
    ...
    def write_array_header(self):
        ...
        for col_pos, column in self.columns.items():
            print('foramt colium header:.....',col_pos,column,column["header"],self.format_header_center)
            self.sheet.write(
                self.row_pos, col_pos, column["header"], self.format_header_center
            )
            print('foramt colium header2222:.....',col_pos,column,column["header"],self.format_header_center)
        self.row_pos += 1
